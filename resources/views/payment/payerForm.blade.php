                        ...
                        <div class="col-sm-6 col-md-offset-3 form-box wow fadeInUp">
                            <div class="form-top">
                                <div class="form-top-left">
                                    <h3>ชำระเงินแล้ว</h3>
                                    <p>คุณชำระเงินผ่าน Paypal เรียนร้อยแล้ว กรุณากรอกอีเมล์ที่ต้องการจะใช้งาน</p>
                                </div>
                            ...
                            <div class="form-bottom">
                                <form role="form" action="/createPayment/" method="post">
                                    ...
                                    <div class="form-group hidden">
                                        ...
                                        <input type="text" name="date" placeholder="วันที่ชำระเงิน" value="Paypal" class="form-control input-lg">
                                    </div>
                                    <div class="form-group hidden">
                                        <label class="sr-only" for="form-first-name">เวลาชำระเงิน</label>
                                        <input type="text" name="time" placeholder="เวลาชำระเงิน" value="Paypal" class="form-control input-lg">
                                    </div>
                                    <div class="form-group hidden">
                                        <label class="sr-only" for="form-first-name">วิธีการชำระเงิน</label>
                                        <input type="text" name="paymentMethod" placeholder="วิธีการชำระเงิน" class="form-control input-lg" value="Paypal">
                                    </div>
